    ...
    <div className="max-w-4xl mx-auto py-8 sm:py-12 px-4 space-y-8 font-mono text-ink">
      ...
      <div className="border border-hairline p-6 sm:p-8 bg-void space-y-8 font-sans text-sm text-ink-dim leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            By accessing or using The Launch Feed (<a href="https://thelaunchfeed.com" className="text-signal hover:underline">thelaunchfeed.com</a>), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not access or use our services.
          </p>
        </section>
        ...
        <section className="space-y-3 border-t border-hairline pt-6">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>You grant The Launch Feed a worldwide, non-exclusive, royalty-free license to host, display, broadcast on official social channels, and distribute machine-readable summaries via <code>/llms.txt</code> for search engine indexing.</li>
